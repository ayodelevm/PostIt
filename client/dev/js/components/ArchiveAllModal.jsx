          ...
          <div className="card white">
            <div className="card-content black-text">
              <div className="row card-title-area">
                <span className="card-title create">Archive All Messages in {props.name}</span>
                <p className="flow-text par grey-text">Are you sure you want to archive all messages in this group?</p>
              </div>
              <div className="row card-form-section">

                <form className="col s12" onSubmit={props.onHandleSubmit} noValidate>
                  <div className="main">
                  ...
                  <div className="row">
                    <div className="input-field col s12">
                      <button className="btn lime accent-4 right waves-effect waves-light center" type="submit" name="action">Archive All
                      </button>
                    </div>
                  </div>
                </form>
