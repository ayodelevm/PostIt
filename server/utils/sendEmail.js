...
const sendEmail = (emails, sentBy, groupName, groupId, origin) => {
  ...
  const mailOptions = {
    ...
    html: `<p>You have a new message in <b>${groupName}</b>, <b>
    sent by:</b> ${sentBy}</p><br />
    <a href="${origin}/groups/${groupId}/message">
    Click here</a> to view the message! <br />
    <p>Note: You received this mail because you have an account on 
    PostIt and belong to the group ${groupName},<br />
